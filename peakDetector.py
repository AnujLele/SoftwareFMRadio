...
import osmosdr
import time
import peakDetector_epy_block_0 as epy_block_0  # embedded python block



class peakDetector(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "peakDetector")
...
def main(top_block_cls=peakDetector, options=None):
